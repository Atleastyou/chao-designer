<template lang="pug">
.edit
  edit-header(headerInfo="广告-大图广告")
  category-modal(
    v-if="showCategory"
  ...
  .edit-content
    .edit-form-item
      .edit-form-item-title 设置间隙
      .edit-form-item-bd
        .edit-form-item_checkbox
          .edit-form-item-checkbox(@click="toggleCheckbox")
            .checkbox(:class="{ 'checkbox_active' : form.isSpace }")
            .checkbox-label 显示图片间的间隙
    .edit-form-item
      ...
      .edit-form-item-bd
        .banner-item(v-for="item, index in form.advers")
          ...
          .banner-item-img
            img(:src="item.img" :ref="`uploader_${index}`" :id="`uploader_${index}`")
